...
class StructureGenerator {
    constructor(uploadDir) {
        ...
        this.dbConfigGenerator = new databaseConfig_1.DatabaseConfigGenerator(uploadDir);
    }
    async createProjectStructure(projectId) {
        ...
        for (const folder of folders) {
            const folderPath = path_1.default.join(convertedDir, folder);
    ...
    mapPhpToNodeStructure(phpFilePath, content) {
        const fileName = path_1.default.basename(phpFilePath, '.php');
    ...
    async createMainIndex(convertedDir) {
...
startServer();
`;
        await fs_1.default.promises.writeFile(path_1.default.join(convertedDir, 'index.ts'), indexContent);
    }
    async createPackageJson(convertedDir) {
        const packageJson = {
        ...
        await fs_1.default.promises.writeFile(path_1.default.join(convertedDir, 'package.json'), JSON.stringify(packageJson, null, 2));
    }
    async createTsConfig(convertedDir) {
        const tsConfig = {
            compilerOptions: {
                target: "ES2020",
                module: "commonjs",
        ...
        await fs_1.default.promises.writeFile(path_1.default.join(convertedDir, 'tsconfig.json'), JSON.stringify(tsConfig, null, 2));
    }
    async createReadme(convertedDir) {
...
`;
        await fs_1.default.promises.writeFile(path_1.default.join(convertedDir, 'README.md'), readmeContent);
    }
    async createPromptGuide(convertedDir) {
...
`;
        await fs_1.default.promises.writeFile(path_1.default.join(convertedDir, 'prompt.md'), promptContent);
    }
    async createEnvExample(convertedDir) {
...
`;
        await fs_1.default.promises.writeFile(path_1.default.join(convertedDir, '.env.example'), envContent);
    }
}
